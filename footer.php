...
<div class="modal fade" id="callModalSkidos" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
...
<label for="city" class="form-icon"><svg width="20" height="20"><use xlink:href="./img/svg/symbol/sprite.svg#map"></use></svg></label>
...
<button class="btn btn-order send_form_zvonok_skidos">Купить <span class="btn-arrow-right"><svg width="18" height="18"><use xlink:href="./img/svg/symbol/sprite.svg#arrow-sm-right"></use></svg></span></button>
</div>
</div>
</form>
</div>
...
<div class="form-group">
<label for="phone" class="form-icon"><svg width="20" height="20"><use xlink:href="./img/svg/symbol/sprite.svg#phone"></use></svg></label>
<input type="text" name="phone" placeholder="Ваш телефон" class="form-control" id="blue-phone" value="">
</div>
<div class="text-center status">
<button class="btn btn-order send_form_zvonok">Заказать звонок <span class="btn-arrow-right"><svg width="18" height="18"><use xlink:href="./img/svg/symbol/sprite.svg#arrow-sm-right"></use></svg></span></button>
</div>
</div>
</form>
</div>
...
<!-- Обратный звонок шапка  !-->
<div class="modal fade" id="callModalBig" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog" role="document">
<div class="modal-content">
<div class="modal-body">
...
<div class="text-center status">
<button class="btn btn-order send_form_zvonok_big">Узнать <span class="btn-arrow-right"><svg width="18" height="18"><use xlink:href="./img/svg/symbol/sprite.svg#arrow-sm-right"></use></svg></span></button>
</div>
</div>
</form>
</div>
...
<div class="modal fade" id="callModalCons" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
<div class="modal-dialog" role="document">
<div class="modal-content">
<div class="modal-body">
...
<div class="text-center status">
<button class="btn btn-order send_form_zvonok_cons">Получить <span class="btn-arrow-right"><svg width="18" height="18"><use xlink:href="./img/svg/symbol/sprite.svg#arrow-sm-right"></use></svg></span></button>
</div>
</div>
</form>
</div>
...
<div class="contacts">
<div class="phone d-block d-lg-none mb-3 mb-lg-2"><a href="#"><svg width="18" height="18"><use xlink:href="./img/svg/symbol/sprite.svg#phon-footer"></use></svg> 8 777 474 84 94</a></div>
<div class="mail mb-3 mb-lg-2 d-flex">
<div class="icon"><svg width="18" height="18"><use xlink:href="./img/svg/symbol/sprite.svg#mail"></use></svg></div>
<a href="mailto:info@BabySafe.pro">info@BabySafe.pro</a>
</div>
<div class="adress d-flex">
<div class="icon"><svg width="18" height="18"><use xlink:href="./img/svg/symbol/sprite.svg#location"></use></svg></div>Казахстан, г.Астана, ул. Акжан, 3 (пос.&nbsp;им.&nbsp;Тельмана)
</div>
</div>
...
<div class="social-item"><a href="https://www.instagram.com/babysafe.pro/"><svg width="18" height="18"><use xlink:href="./img/svg/symbol/sprite.svg#in"></use></svg></a></div>
</div>
</div>
</footer>
	...
	({
      ...
      $('.modal-body .mask .text-center.status').html(buttom);
		...
		success: function(response)
		{
			...
			{
				setTimeout(function() {	location.href = '/thankyoupage/'; }, 900);
			}
...
$(document).on('click','form.price-form.form-default.partnership .send_form_partnership',function(e)
{
  ...
  var buttom = '<button type="submit" class="btn btn-order send_form_partnership">Получить файл<span class="btn-arrow-right"><svg width="18" height="18"><use xlink:href="./img/svg/symbol/sprite.svg#arrow-sm-right"></use></svg></span></button>';
	...
	({
		url: "/send.php",
		type: "POST",
		data: {"city": city, "name": name, "phone": phone, "email": email,  "types": type, "type": "send_form_partnership"},
		cache: true,
		beforeSend: function()
		{
